...
class Descripter
{
    ...
    public static string GetDescription3(Person person)
    {
        ...
        {
        Person { Gender: "Female", PersonMartialStatus: MaritalStatus.Unmarried,
            BirthDate.DateOfBirth.Year: > 2000 } p => $"Miss. {p.Name}", //person.Gender == "Female" && person.PersonMartialStatus == MartialStatus.Unmarried && person.BirthDate.DateOfBirth.Year > 2000
...
class Program
{
    static void Main()
    {
        Manager manager = new Manager() { Name = "John", Gender = "Male", Age = 16, Salary = 3000, PersonMartialStatus = MaritalStatus.Married, 
