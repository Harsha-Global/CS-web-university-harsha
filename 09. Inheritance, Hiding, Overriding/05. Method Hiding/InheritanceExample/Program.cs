class Program
{
    static void Main()
    {
        ...
        System.Console.WriteLine(mgr1.GetHealthInsuranceAmount()); //Only Manager.GetHealthInsuranceAmount
        System.Console.WriteLine();
        ...
        System.Console.WriteLine(salesMan1.GetHealthInsuranceAmount()); //Only Employee.GetHealthInsuranceAmount
        System.Console.WriteLine();
